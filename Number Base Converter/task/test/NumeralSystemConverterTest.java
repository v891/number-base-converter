...
class Converter {
    ...
    static String fractionToBaseX (String number, int targetBase) {
        ...
        BigDecimal doubleOfDecInp = new BigDecimal(number).setScale(10, RoundingMode.FLOOR);
        
        BigInteger beforeDot = new BigDecimal(number).setScale(10, RoundingMode.FLOOR)
                                                     .toBigInteger();
        output.append(beforeDot.toString(targetBase));
        
        BigDecimal bfd = new BigDecimal(beforeDot).setScale(10, RoundingMode.FLOOR);
